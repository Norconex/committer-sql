...
class SQLClient {
        ...
        try {
            while (it.hasNext()) {
                ...
                if (req instanceof UpsertRequest) {
                    dbUpsert((UpsertRequest) req);
                    upsertCount++;
                } else if (req instanceof DeleteRequest) {
                    dbDelete((DeleteRequest) req);
                    deleteCount++;
                } else {
    ...
    private String resolvePkValue(ICommitterRequest req) {
        Properties meta = req.getMetadata();
    ...
    private boolean isTargetFieldAlreadySet(
            ICommitterRequest req, String refOrContent, String field) {
